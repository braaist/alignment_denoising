...
OUT_FOLDER_PATH = "/data/ruslan_gumerov/actinobacteria/"
#path to folder with domains and proteins for given group_name and tax_levels
#path to output fasta folder
PATH_TO_OUTPUT_FASTA_DIR = OUT_FOLDER_PATH + "actinobacteria_fasta/"
#path to the table with mapping between randomly selected proteins, their species and genuses
PATH_TO_MAIN_SELECTION_TABLE = OUT_FOLDER_PATH + "actinobacteria_proteins_species_orders_mapping.csv"
#path to the output .csv files with domains and proteins for given genus
PATH_TO_DOMAIN_CSV = OUT_FOLDER_PATH + "actinobacteria_domains_and_proteins_csv/"
