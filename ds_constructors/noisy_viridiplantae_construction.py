...
GROUP_NAME = "VIRIDIPLANTAE"
parental_tax_level = "kingdom"
parental_tax_id = "33090"
...
OUT_FOLDER_PATH = "/data/ruslan_gumerov/viridiplantae/"
#path to folder with domains and proteins for given group_name and tax_levels
#path to output fasta folder
PATH_TO_OUTPUT_FASTA_DIR = OUT_FOLDER_PATH + "viridiplantae_fasta/"
#path to the table with mapping between randomly selected proteins, their species and genuses
PATH_TO_MAIN_SELECTION_TABLE = OUT_FOLDER_PATH + "viridiplantae_proteins_species_orders_mapping.csv"
#path to the output .csv files with domains and proteins for given genus
PATH_TO_DOMAIN_CSV = OUT_FOLDER_PATH + "viridiplantae_domains_and_proteins_csv/"
