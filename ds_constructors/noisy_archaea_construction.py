...
if __name__ == "__main__":
    ...
    for proteins, orders in zip(proteins_out["apply"], proteins_out[aggregation_tax_level]):
        ...
        new_list = [line.split(" ")[0][1::] for line in open(f"{PATH_TO_OUTPUT_FASTA_DIR}/{counter_fasta}.fasta") if line.startswith(">")]
